...
// our email templates. This has a comment directive in teh format `//go:embed <path>`
...
func (m Mailer) Send(recipient, templateFile string, data any) error {
	...
	// headers, the SetBody() method to set the plain-text boyd, and teh AddAlternative()
	...
	// connection. If there is a timeout, ti will return a "dial tcp: i/o timeout"
	// error.
