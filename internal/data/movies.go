...
func (m *MovieModel) Insert(movie *Movie) error {
	...
	// teh movie struct. Declaring this slice immediately next to our SQL query helps to
...
func (m *MovieModel) Get(id int64) (*Movie, error) {
	...
	// as a placehodler parameter, and scan the response data into the fields of the
...
func (m *MovieModel) Delete(id int64) error {
	...
	// the value for the placeholder parameter. The Exec() method return a sql.Result
	// object.
