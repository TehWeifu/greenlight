...
// version of the password for a suer. The plaintext field is a *pointer* to a string,
...
// Insert a new record in the database for the user. Not that the id, created_at and
...
func (m UserModel) Insert(user *User) error {
	...
	// If the talbe already contains a record with this email address, then when we try
...
// field to help prevent any race considerations during the request cycle, just like we did
// when updating a movie. And we also check for a violation of the "users_email_key"
// contraction when performing the update, just like we did when inserting hte user
// record originally.
...
func (m UserModel) GetForToken(tokenScope, tokenPlainText string) (*User, error) {
	...
	// to get a slice containing the token has, rather than passing in the array (which
