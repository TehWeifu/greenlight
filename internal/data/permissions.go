...
// Define a Permissions slice, which we wil use to hold permissions codes (like
// "moves:read" and "movies:write") for a single user.
...
// The GetAllForUser() method returns all permissions codes for a specific user in a
// Permissions lice. The code in this method should feel very familiar --- it uses the
